...
A CLI tool that scaffolds token-optimized agentic frameworks for AI-assisted development. Uses **pi-first architecture** where `.pi/` is the source of truth and other formats (`.claude/`, `.opencode/`, `.agents/`) are generated exports.
